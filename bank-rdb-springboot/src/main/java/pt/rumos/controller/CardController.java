...
public class CardController {
    ...
    public Card createCreditCard(@RequestBody CreditCard creditCard, Integer accountId, Integer clientId) throws Exception {
    ...
    public Card createDebitCard(@RequestBody DebitCard debitCard, Integer accountId, Integer clientId) throws Exception {
